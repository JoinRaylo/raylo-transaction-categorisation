...
eqx_resolved AS (
  SELECT r.*,
    CASE
      ...
      WHEN LOWER(TRIM(r.vendor))='wik' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.vendor))='fitzsimons' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.vendor))='derek' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.vendor))='jasmine' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.vendor))='hart' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.vendor))='blackwell\'s' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.vendor))='hiba' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.vendor))='pier' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
    ...
    CASE
      ...
      WHEN LOWER(TRIM(r.vendor))='wik' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_1'
      ...
      WHEN LOWER(TRIM(r.vendor))='fitzsimons' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_2'
      ...
      WHEN LOWER(TRIM(r.vendor))='derek' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_3'
      ...
      WHEN LOWER(TRIM(r.vendor))='jasmine' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_4'
      ...
      WHEN LOWER(TRIM(r.vendor))='hart' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_5'
      ...
      WHEN LOWER(TRIM(r.vendor))='blackwell\'s' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_6'
      ...
      WHEN LOWER(TRIM(r.vendor))='hiba' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_7'
      ...
      WHEN LOWER(TRIM(r.vendor))='pier' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_8'
...
plaid_resolved AS (
  SELECT r.*,
    CASE
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='wik' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='fitzsimons' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='derek' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='jasmine' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='hart' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='blackwell\'s' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='hiba' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='pier' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'transfer_p2p'
    ...
    CASE
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='wik' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_1'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='fitzsimons' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_2'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='derek' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_3'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='jasmine' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_4'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='hart' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_5'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='blackwell\'s' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_6'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='hiba' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_7'
      ...
      WHEN LOWER(TRIM(r.merchant_raw))='pier' AND REGEXP_CONTAINS(LOWER(COALESCE(r.description_raw, '')), r'sortcode|faster\s*payment|\bfps\b|\bmob\b|\bft\b|\bbank\s+transfer\b|\btransfer\b|\d{10}') THEN 'T2_compound_p2p_payee_collision_8'
