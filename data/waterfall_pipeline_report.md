...
Eval rows written to `outputs/gold_pipeline_eval.csv` (2004 after dedupe).
...
Source mix: risk 628, unified_v2_batch2 578, unified_v2 459, unified_v3 285, unified_v4 54

## Pipeline eval (row-disjoint from training) (n=2004)

| Slice | n | leaf | general |
|---|---:|---:|---:|
| T1–T5 (when that tier fired) | 1499 | 89.2% | 94.2% |
| classifier on residual (T6/T7-bound) | 505 | 59.8% | 66.9% |
| T6/T7 backup on residual | 505 | 25.0% | 39.0% |
| full pipeline: T1–T5 then hinge | 2004 | 81.8% | 87.3% |
| rules-only waterfall (T1–T7, no ML) | 2004 | 73.0% | 80.3% |
| full pipeline — debit rows | 1824 | 84.2% | 89.5% |
| full pipeline — credit rows | 180 | 57.8% | 65.6% |
| classifier on residual — credit rows | 62 | 41.9% | 46.8% |
| full pipeline — human_adjudicated_v2 rows | 1037 | 77.7% | 83.1% |
| full pipeline — llm_drafted_agent_adjudicated rows | 967 | 86.1% | 91.8% |
...
| `T6_native_fallback` | 417 | 30.2% |
| `T7_unclassified` | 88 | 0.0% |
| `T5_R31` | 16 | 100.0% |
...
The 72.0% rules-only number is **T1–T7** (Plaid/Equifax as T6 on the leftover). This table is the other question: on rows our waterfall already resolves at **T1–T4** (n=1446 of 2004), how does that leaf compare with mapping the provider's own category through T6 only. Native-filled only — risk gold has no `native_category` (528 Plaid T1–T4 rows omitted).
...
| Slice | n | leaf | general |
|---|---:|---:|---:|
| all 1,884 (blank native → unclassified_other) | 2004 | 29.9% | 41.5% |
...
| `savings_transfer` | 5 | 60.0% (3/5) | 80.0% (4/5) | +20.0% | 780 |
...
|---|---:|---:|---:|---:|---:|
| `savings_investments` | 13 | 61.5% (8/13) | 84.6% (11/13) | +23.1% | 1,824 |
| `childcare_education` | 14 | 64.3% (9/14) | 85.7% (12/14) | +21.4% | 2,720 |
| `business_self_employment` | 5 | 20.0% (1/5) | 40.0% (2/5) | +20.0% | 2,812 |
| `clothing_personal_care` | 21 | 66.7% (14/21) | 71.4% (15/21) | +4.8% | 10,737 |
...
| `savings_transfer` | 5 | 60.0% (3/5) | 80.0% (4/5) | +20.0% | 780 |
| `accommodation` | 8 | 50.0% (4/8) | 62.5% (5/8) | +12.5% | 1,973 |
| `refund_received` | 10 | 0.0% (0/10) | 0.0% (0/10) | +0.0% | 348 |
| `mortgage` | 6 | 100.0% (6/6) | 100.0% (6/6) | +0.0% | 226 |
...
| `taxi_rideshare` | 6 | 83.3% (5/6) | 66.7% (4/6) | -16.7% | 2,568 |
| `gym_fitness` | 5 | 60.0% (3/5) | 40.0% (2/5) | -20.0% | 2,414 |
| `transfer_own_account` | 14 | 21.4% (3/14) | 0.0% (0/14) | -21.4% | 728 |
| `unclassified_other` | 12 | 25.0% (3/12) | 0.0% (0/12) | -25.0% | 15,003 |
| `convenience_store` | 8 | 75.0% (6/8) | 50.0% (4/8) | -25.0% | 30,269 |
| `council_tax` | 6 | 50.0% (3/6) | 16.7% (1/6) | -33.3% | 2,728 |
| `debt_collection` | 5 | 60.0% (3/5) | 20.0% (1/5) | -40.0% | 1,042 |
...
| `transfer_p2p` | 48 | 62.5% (30/48) | 2.1% (1/48) | -60.4% | 103,360 |
| `beauty_treatment` | 10 | 70.0% (7/10) | 0.0% (0/10) | -70.0% | 4,440 |
| `credit_reporting_service` | 5 | 100.0% (5/5) | 20.0% (1/5) | -80.0% | 101 |
...
| risk gold `gold_transactions_risk_categories.csv` | 711 | 0 (0.0%) |
