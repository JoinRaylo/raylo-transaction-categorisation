...
- **B03-B authority boundary (16 Sep):** [Adapter contract and synthetic evidence](docs/benchmark-implementation/b03-b-production-boundary-2026-09-16/ADAPTER_CONTRACT.md). The canonical app package now has injected immutable-object and registry/CAS ports with lazy GCS/Firestore adapters; fourteen synthetic boundary tests pass. No physical cloud scope, IAM, KMS receipt, real membership or consumer integration is approved.
