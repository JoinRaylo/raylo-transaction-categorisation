...
- **B03-D synthetic candidate allocation (17 Sep):** [Design and evidence](docs/benchmark-implementation/b03-d-synthetic-allocation-2026-09-17/README.md). A strict synthetic-fixture/policy-scoped planner now assigns whole opaque identity/projection blocks in protected-before-training order, preserves the three-view semantics, rejects strict novelty collisions and contradictory blocks, and records explicit capacity shortfalls without authority. 18 adversarial allocator tests plus the full library/app unit suites pass. No real rows, labels, authority writes, locked-set access, scoring or retraining occurred; effective IAM attestation and managed admission remain the next real-data gate.
