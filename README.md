...
- **B03-B authority boundary (17 Sep):** [Adapter contract and synthetic evidence](docs/benchmark-implementation/b03-b-production-boundary-2026-09-16/ADAPTER_CONTRACT.md). The canonical app package has injected immutable-object and registry/CAS ports plus a strict exact-object authenticated receipt path bound to an authority-resolved worker audience and backed by an authority signer port and lazy KMS adapter; twenty synthetic boundary tests pass. No physical cloud scope, IAM/KMS custody, real membership or B04 consumer integration is approved.

- **B03-B physical scope review (17 Sep):** [Proposal and proof checklist](docs/benchmark-implementation/b03-b-physical-scope-review-2026-09-17/README.md). This packet names the concrete project/location, immutable stores, identities, retention, KMS custody and worker public-key verification decisions that must be approved before any live probe. It is proposal-only: no resources, IAM, KMS, customer data, membership, labels or B04 consumer were changed.
