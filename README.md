...
- **Now (7 Sep 2026):** pipeline **83.2%** leaf on 2,000 rows (transformer) vs provider-native **29.9%**; risk model month6 Gini live **0.385** / August 50-feature **0.562** / capped champion (single XGB) **0.588** / uncapped **0.618** / capped + text + encoder **0.621**.
