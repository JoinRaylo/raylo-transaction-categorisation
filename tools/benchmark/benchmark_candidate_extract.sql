-- Deterministic source draw from the current customer-linked Plaid materialization.
-- The output is private engineering input; it is not an authority reservation.
