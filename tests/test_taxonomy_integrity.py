...
def test_hmrc_t2_eval_harness_matches_gold_examples():
    ...
    cases = [
        ("HM Revenue and Customs", "credit",
         "HMRC CHILD BENEFIT  KELLY00LAURA123450 BGC",
        ...
        ("HMRC", "credit", "HMRC SA  1234567891K00002 BGC",
        ...
        ("Vodafone", "debit", "DIRECT DEBIT PAYMENT TO VODAFONE LTDDEVICE REF 1234567892",
        ...
        ("Wik", "debit", "A N Other - SortCodeAccountNumber: 12345678901233",
         "transfer_p2p", "T2_compound_p2p_payee_collision_1"),
        ("Wik", "debit", "A N Other repayment",
        ...
        ("Jasmine", "debit", "A N Other - SortCodeAccountNumber: 12345678901234",
         "transfer_p2p", "T2_compound_p2p_payee_collision_4"),
        ...
        ("Egg", "debit", "Direct debit EGG 162224 12345675",
        ...
        ("A Person", "credit", "A Person Refunded",
         "refund_received", "T2_compound_refund"),
        ("Spring", "credit", "Returned direct debit CREDITSPRING 070806 12345676",
        ...
        ("Scholastic Rail", "debit", "SCHOLASTIC BOOK FAIR",
         "books", "T5_R24"),
        ("Admiral", "debit", "ADMIRAL INSURANCE P12345678901234567",
        ...
        ("Royal London", "debit", "ROYAL LONDON 12345678",
         "insurance_life", "T4_dictionary"),
        ("Places for People", "debit", "PLACES FOR PEOPLE 1234567899",
         "rent", "T4_dictionary"),
        ...
        ("Spring", "credit", "Returned direct debit CREDITSPRING 070806 12345670",
         "returned_payment", "T2_compound_returned_payment"),
        ...
        ("Help to Buy", "debit", "DIRECT DEBIT PAYMENT TO HELP TO BUY",
         "personal_loan_repayment", "T4_dictionary"),
        ("Virgin Mobile", "debit", "123456781 Virgin Mobile",
        ...
        ("The Grove", "debit", "The Grove ON 27 JUL CPM",
         "pub_bar", "T4_dictionary"),
        ("Standing Order", "credit", "Returned standing order NIHE 123452",
         "returned_payment", "T2_compound_returned_payment"),
        ...
        ("Plus", "debit", "Direct debit PLUS1234563-1",
        ...
        ("Home", "debit", "247 HOME RESCUE GC123454 DDR",
        ...
        ("", "debit", "Direct debit STEPCHANGE 074456 12345675",
         "debt_management_plan", "T5_R31"),
        ("", "debit", "STEPCHANGE                            REFERENCE: 1234566",
         "debt_management_plan", "T5_R31"),
        ("Stepchange", "debit", "STEPCHANGE  1234567 DDR Stepchange",
...
def test_card_issuer_and_overdraft_t5_rules_no_labelled_false_positives():
    ...
    fixtures = [
        ...
        ("HSBC BNK VSA123456789018******4482", "debit", "credit_card_repayment"),
        ("LLOYDS BANK PLATIN 123456789012345679", "debit", "credit_card_repayment"),
        ("CREDIT CARD 123456789012345670", "debit", "credit_card_repayment"),
        ...
        ("HSBC BNK VSA123456789011******4482", "credit", None),   # credits never fire
...
def test_blank_merchant_t5_rules_r38_r51_fixtures():
    ...
    for desc, expected in [
        ...
        ("Hme Rtl Grp Cards, 12345678902III2163", "revolving_credit_repayment"),
        ...
        ("CASE: DRS123453 CARD: ****1234", "debt_collection"),
