...
Two different problems sit in this work and they want different tools. The first is reading text: turning a merchant string and narrative into one of 275 categories. The second is ranking applicants: turning a table of per-applicant numbers into a default probability. The choices were made for each separately, and each was tested against the simpler alternative before being kept.
...
XGBoost on 50 taxonomy features & The live model is an XGBoost, so this isolates the value of our categories with the learner held constant. & 0.56 against 0.39 live. The August headline. \\ \addlinespace[4pt]
