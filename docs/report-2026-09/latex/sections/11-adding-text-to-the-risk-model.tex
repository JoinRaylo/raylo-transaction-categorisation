...
\caption*{Eight encoders spanning a 25-fold range in size land in one band on both bases. On the 50-feature champion the lifts are two to three times larger and every GINI interval excludes zero. The category-fine-tuned encoder is weakest on both.}
\end{figure}
