...
def fetch():
    ...
    eval_protection.write_artifact_receipt(
        SAMPLE_CSV, consumer="build_final_gold_v2.fetch",
...
def apply_review(path):
    ...
    eval_protection.write_artifact_receipt(
        FINAL_CSV, consumer="build_final_gold_v2.apply_review",
